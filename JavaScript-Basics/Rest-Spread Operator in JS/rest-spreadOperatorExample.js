...
// Get a specific book (ID: 1)
const book = getBook(1);

// Rest and Spread Operator in Arrays

// Extract primaryGenre and secondaryGenre and remaining genres in array by using Rest Operator
const [primaryGenre, secondaryGenre, ...otherGenres] = book.genres;
console.log(primaryGenre, secondaryGenre, otherGenres);

// Create a new array newGenres by copying genres and adding "epic fantasy" using Spread Operator
...
// Note: In the above examples, 'book' represents the book object with ID: 1 from the data array.
