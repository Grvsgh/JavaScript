...
// Get a specific book (ID: 2)
const book = getBook(2);

// Destructure the book object to extract specific properties
const { title, author, publicationDate, genres } = book;
console.log(title, author, publicationDate, genres);

// Destructure the 'genres' array to extract primary and secondary genres
